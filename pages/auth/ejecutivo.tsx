        ...
        <>
            ...
            <Box sx={styles.mainContainer}>
                <Box sx={styles.loginContainer}>
                    ...
                    <Typography variant="h4" sx={{ fontFamily: "Plus Jakarta Sans", fontWeight: "800" }}>Iniciar sesión como ejecutivo</Typography>
