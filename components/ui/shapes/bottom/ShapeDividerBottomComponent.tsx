...
import styles from './ShapeDividerBottomComponent.module.css';

export const ShapeDividerBottomComponent: FC = () => {
    return (
        <div className={styles["custom-shape-divider-bottom-1680102307"]}>
