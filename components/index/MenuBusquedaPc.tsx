            ...
            <Box sx={styles.contenedorBotonera}>
                ...
                <Box sx={{ position: "relative", overflowY: "hidden", }}>
                    <Box id="button-banner" ref={refBotonera} sx={styles.botonera}>
                        ...
                        <Button sx={styles.botonLocalidad} variant="text" onClick={() => handleFilter("Safari")}>Safari</Button>
                    ...
                    <Box sx={styles.contenedorSend}>
                        <form onSubmit={onSubmit} style={{ margin: 0, padding: 0, display: "flex", flexFlow: "row nowrap", width: "100%" }}>
