...
const Contacto = () => {
    return (
        <>
            ...
            <Box>
                <Typography component="p" sx={{ display: "flex", alignItems: "start", textAlign: "justify", fontFamily: "Hind", }}><HomeRoundedIcon /> Av. Prolongación Michelena, Centro Comercial "ARA", Nave "E", Local 80-A-52. Estado, Valencia, Carabobo</Typography>
            </Box>
            <Box>
