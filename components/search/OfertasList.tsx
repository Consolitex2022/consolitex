    ...
    return (
        <Grid container sx={{ width: '100%', mb: 2, }} spacing={1} >
            <Grid item xs={12} sm={6} onClick={() => window.open('/inmueble/ARV0235', '_blank')} sx={{ cursor: 'pointer' }}>
                <Box sx={{ p: 2, background: '#fff', borderRadius: 3, boxShadow: '0 2px 8px rgba(100,100,100,0.4)', display: 'flex', flexFlow: 'row nowrap', justifyContent: 'space-evenly', alignItems: 'center' }}>
                    <Box >
