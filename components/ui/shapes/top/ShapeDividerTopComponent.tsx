...
import styles from './ShapeDividerTopComponent.module.css';

export const ShapeDividerTopComponent: FC = () => {
    return (
        <div className={styles["custom-shape-divider-top-1680113108"]}>
