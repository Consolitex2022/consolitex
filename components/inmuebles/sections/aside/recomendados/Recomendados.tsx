                                ...
                                related.map((rel: any) => (
                                    <Box component="div" key={rel.data.key}>
                                        <Box component="div" sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                                            <CustomImage upperBoxStyles={{ width: 80, height: 80, borderRadius: 3, overflow: "hidden" }} src={`https://cnsltx.co/fotos/newImg.php?url=${encodeURI(rel.url_inmueble)}`} alt={`Inmueble recomendado - ${rel.data.nombre}`} />
                                        </Box>
